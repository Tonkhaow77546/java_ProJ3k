...
public class TimeValueUI implements ActionListener{
    ...
    private JPanel rootPanel, topPanel, subPanel, subPanelTop;
    private JButton btnChangMode;
    private JLabel topLabel, modeLabel;
    private FutureValueUI FN1;
    private PresentValueUI FN2;
    public TimeValueUI(){
