...
public class PresentValueUI implements ActionListener{
    ...
    private JPanel subFutureResult, subReward, subTime, subButton, subResult;
    private JLabel JHeadLabel, JFutureLabel, JRewardLabel, JTimeLabel, JResult1, JResult2;
    private JPanel part1, part2, part3;
    private JTextField JFutureText, JRewardResultText, JTimeText;
    private JButton JSummitButton, JResetButton;
    private PresentValue presentValueFN;
...
//        frame.add(panelFrame, BorderLayout.CENTER);
        ...
        JHeadLabel= new JLabel("Present Value: PV", SwingConstants.CENTER);
