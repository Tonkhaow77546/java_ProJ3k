...
public class FutureValueUI implements ActionListener{
    ...
    JPanel subPresentResult, subReward, subTime, subButton, subResult;
    JLabel JPresentLabel, JRewardLabel, JTimeLabel, JResult1, JResult2;
    JPanel part1, part2, part3;
    JTextField JPresentText, JRewardResultText, JTimeText;
    JButton JSummitButton, JResetButton;
   
    FutureValue futureValueFN;
